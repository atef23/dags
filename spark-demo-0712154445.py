...
args = {
    "project_id": "spark-demo-0712154445",
}

dag = DAG(
    "spark-demo-0712154445",
    default_args=args,
...
notebook_op_d5009697_771e_4f71_bc20_e52d905c9f9d = NotebookOp(
    ...
    cos_endpoint="http://minio-ml-workshop-ml-workshop.apps.cluster-hgm2c.hgm2c.sandbox1764.opentlc.com",
    cos_bucket="airflow",
    cos_directory="spark-demo-0712154445",
    ...
    env_vars={
        ...
        "WORKER_NODES": "2",
        "S3_ENDPOINT_URL": "http://minio-ml-workshop-ml-workshop.apps.cluster-hgm2c.hgm2c.sandbox1764.opentlc.com",
    },
    config_file="None",
    dag=dag,
)
