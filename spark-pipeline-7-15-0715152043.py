...
args = {
    "project_id": "spark-pipeline-7-15-0715152043",
}

dag = DAG(
    "spark-pipeline-7-15-0715152043",
    default_args=args,
    schedule_interval="@once",
    start_date=days_ago(1),
    description="Created with Elyra 2.2.4 pipeline editor using spark-pipeline-7-15.pipeline.",
...
notebook_op_d5009697_771e_4f71_bc20_e52d905c9f9d = NotebookOp(
    ...
    cos_endpoint="http://minio-ml-workshop-ml-workshop.apps.cluster-r6vtc.r6vtc.sandbox1525.opentlc.com",
    cos_bucket="airflow",
    cos_directory="spark-pipeline-7-15-0715152043",
    ...
    env_vars={
        ...
        "WORKER_NODES": "2",
        "S3_ENDPOINT_URL": "http://minio-ml-workshop-ml-workshop.apps.cluster-r6vtc.r6vtc.sandbox1525.opentlc.com/",
    },
    config_file="None",
    dag=dag,
)
