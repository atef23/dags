...
args = {
    "project_id": "spark-demo-0705192800",
}

dag = DAG(
    "spark-demo-0705192800",
    default_args=args,
...
notebook_op_d5009697_771e_4f71_bc20_e52d905c9f9d = NotebookOp(
    ...
    cos_bucket="airflow",
    cos_directory="spark-demo-0705192800",
    ...
    env_vars={
        ...
        "WORKER_NODES": "2",
        "S3_ENDPOINT_URL": "http://minio-ml-workshop-ml-workshop.apps.cluster-rcvqh.rcvqh.sandbox894.opentlc.com",
    },
    config_file="None",
    dag=dag,
)
